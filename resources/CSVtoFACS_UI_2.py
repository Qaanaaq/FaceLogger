...
class FUNCTION_OT_my_head(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        #conflict checks
        if bpy.data.objects.get("Neutral") is not None:            
...
class FUNCTION_OT_my_drivers(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if bpy.data.objects.get("FACS_Controller") is None:            
            ...
            if bpy.data.objects.get("Neutral") is None:            
                ...
                while (k < actionUnitNumber): 
                    ...
                    shape_key = bpy.data.objects['Neutral'].data.shape_keys
                    source = shape_key                
